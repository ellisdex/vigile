...
->DONE
=Boabaird
{The Chief awaits your return, greeting you graciously when you enter. <p></p>"Vigile. What is it you need from me today?"|When you enter Mai Dunn, the chief looks tired. He greets you courteously.} {DAY >= 24 && MONTH == 1: Boabaird looks as though he has been expecting you, and nods his head as you approach. <p></p>"Good, it’s you, Vigile. Just the person I need right now." ->cranninfo}
-(questions)
    *(askjob){not Boabaird_Ask_Job}[Ask if he has any more jobs for you] You ask if he has more jobs for you. 
    {advancetime(30,0,0,0)}
        ...
        ->questions
    *(askagaintattoos){daytalktoboabaird < DAY}[Ask if he has news about the man with tattoos]"Do you have news on the tattooed man?" you ask.
    {advancetime(30,0,0,0)}
...
{arrestsuspect == "Marcia" || arrestsuspect == "Saoir": You have solved the string of robberies in town. There is nothing else for you to do here.}
//{advancetime(0,0,0,0)}
//{whattimeDEBUG()}
...
*"How many people have been robbed?"
    {advancetime(30,0,0,0)}"Near the whole village!" a woman cries, "that's whys we think were so close to finding the culprit." she eyes a number of individuals in the crowd who look sheepishly away.
    ->introqs
...
-(invsmithy)
    ...
    *(smithyforge)[Inspect the forge]
        You take a closer look at the vandalised forge, bricks have been broken or removed from the structure, you not a small insignia on some of the exposed bricks.
    ->invsmithy
...
-(invstore)
    ...
    *(storestoreroom)[Investigate the storeroom]
    ...
    +{(storestock || storestoreroom) && (not asksmithycounter || not asksmithybedroom || not asksmithyforge|| not asksmithyfloor)}[Ask Marcia something]
...
*{Mai_Dunn.Boabaird_Opening && not Mai_Dunn.Boabaird.askagaintattoos}"I have spoken to Chief Boabaird, who will inform me if any of his people spot the man with tattoos from before."
        ...
        {alter(hasmoney,8)}{alter(hassupplies,3)}
        ->updates
...
*{BathTavern.Macdudd_Invite}"I found the tattooed man in Bath and convinced him to give me information. The man's name is Macdudd; he was hired by druids, one named Chossach in particular, for help with abducting people for a ritual sacrifice on Imbolc, the first of Februarius."
    {30secs()}
     He pauses his scribing, a rare act for him, and stares at you. "So my nephew, whom you so dutifully hunted down for me, could have been a sacrifice for some backwater Celts and their heretical holiday? Thank Iuno Sospina you found him and the others in time. This is certaionly deserving of your salary.
